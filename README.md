...
**ExcelMvc.Net lets you write your own high performance user defined functions (UDF), including RTD functions and asynchronous functions.**

UDF samples:
- **https://github.com/triaxia/ExcelMVC/tree/master/Examples/Udf**

Also if you are a fan of building applications using the MVC/MVVM pattern and you love Excel as the user interface for
your applications, then ExcelMvc.Net is the just component you need.

ExcelMvc.Net lets you write Excel applications like writing WPF or WinForm ones using the MVC/MVVM pattern.
